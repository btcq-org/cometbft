...
type PublicKey_Mldsa struct {
	Mldsa []byte `protobuf:"bytes,4,opt,name=mldsa,proto3,oneof" json:"mldsa,omitempty"`
}

func (*PublicKey_Ed25519) isPublicKey_Sum()   {}
func (*PublicKey_Secp256K1) isPublicKey_Sum() {}
func (*PublicKey_Bls12381) isPublicKey_Sum()  {}
func (*PublicKey_Mldsa) isPublicKey_Sum()     {}
...
func (m *PublicKey) GetMldsa() []byte {
	if x, ok := m.GetSum().(*PublicKey_Mldsa); ok {
		return x.Mldsa
	}
	return nil
}
...
var fileDescriptor_cb048658b234868c = []byte{
	...
	0x44, 0xd2, 0xf3, 0xd3, 0xf3, 0xc1, 0xb2, 0xfa, 0x20, 0x16, 0x44, 0xa1, 0x52, 0x1f, 0x23, 0x17,
	...
	0x8b, 0x10, 0x12, 0x92, 0xe1, 0xe2, 0x48, 0xca, 0x29, 0x36, 0x34, 0x32, 0xb6, 0x30, 0x94, 0x60,
	0x86, 0x4a, 0xc3, 0x45, 0x84, 0xc4, 0xb8, 0x58, 0x73, 0x73, 0x52, 0x8a, 0x13, 0x25, 0x58, 0xa0,
	0x52, 0x10, 0xae, 0x15, 0xc7, 0x8b, 0x05, 0xf2, 0x8c, 0x2f, 0x16, 0xca, 0x33, 0x3a, 0xb1, 0x72,
	0x31, 0x17, 0x97, 0xe6, 0x3a, 0xf9, 0x9d, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83,
	0x47, 0x72, 0x8c, 0x13, 0x1e, 0xcb, 0x31, 0x5c, 0x78, 0x2c, 0xc7, 0x70, 0xe3, 0xb1, 0x1c, 0x43,
	0x94, 0x49, 0x7a, 0x66, 0x49, 0x46, 0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae, 0x7e, 0x72, 0x7e, 0x6e,
	0x6a, 0x49, 0x52, 0x5a, 0x09, 0x82, 0x01, 0xf1, 0x19, 0x46, 0xa0, 0x24, 0xb1, 0x81, 0x25, 0x8c,
	0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xce, 0x6f, 0x6c, 0x75, 0x30, 0x01, 0x00, 0x00,
}
...
func (this *PublicKey_Mldsa) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
	...
	that1, ok := that.(*PublicKey_Mldsa)
	if !ok {
		that2, ok := that.(PublicKey_Mldsa)
		if ok {
			that1 = &that2
		} else {
			return 1
	...
	if c := bytes.Compare(this.Mldsa, that1.Mldsa); c != 0 {
		return c
	}
	return 0
}
...
func (this *PublicKey_Mldsa) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}
	...
	if !bytes.Equal(this.Mldsa, that1.Mldsa) {
		return false
	}
	return true
}
...
func (m *PublicKey_Mldsa) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PublicKey_Mldsa) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Mldsa != nil {
		i -= len(m.Mldsa)
		copy(dAtA[i:], m.Mldsa)
		i = encodeVarintKeys(dAtA, i, uint64(len(m.Mldsa)))
		i--
		dAtA[i] = 0x22
	}
	return len(dAtA) - i, nil
...
func (m *PublicKey_Mldsa) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PublicKey) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Mldsa", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
